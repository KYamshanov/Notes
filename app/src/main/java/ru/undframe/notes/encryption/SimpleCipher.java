package ru.undframe.notes.encryption;
...
public class SimpleCipher {
    ...
    static{
        try {
            ...
            PublicKey publicKey = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(Base64.decode(PUBLIC_KEY_BASE64.getBytes(), Base64.DEFAULT)));
